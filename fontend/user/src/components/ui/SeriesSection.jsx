...
const seriesData = [
  {
    id: 1,
    name: "ROG MATRIX",
    tagline: "Tản Nhiệt Vô Cực", // dch t "Infinity Loop Cooling"
  ...
  },
  {
    id: 2,
    name: "ROG ASTRAL",
    tagline: "Tiên Phong Công Nghệ", // dch t "The Next Frontier"
  ...
  },
  {
    id: 3,
    name: "ROG STRIX",
    tagline: "Thống Lĩnh Cuộc Chơi", // dch t "Take Flight"
...
{/* XA TH <h2> CHA CH "CARD HA" B LP LI Y */}
